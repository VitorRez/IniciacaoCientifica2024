...
export default class AccessPage extends Component {
    ...
    handleAccessButtonPressed() {
        ...
        fetch("/backend/accesspage", requestOptions)
    ...
    render() {
        return(
            <Grid container spacing={1}>
                ...
                <Grid item xs={12} align="center">
                    <Link to="/voterpage"><Button color="primary" variant="contained" onClick={this.handleAccessButtonPressed}>Enter</Button></Link>
                </Grid>
                <VoterPage name={this.state.name} cpf={this.state.cpf} electionid={this.state.electionid}></VoterPage>
            </Grid>
        );
    }
}